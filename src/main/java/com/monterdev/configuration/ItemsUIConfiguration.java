...
public class ItemsUIConfiguration extends GlobalConfiguration {
    ...
    //Custom getters/////////////////////////////////////
    public String getAddItemsButtonName() {
        return globalConfiguration.getConfigValue(ITEMS_ADD_ITEM_BUTTON_NAME);
    }
    public  String getExportButtonName() {
        return globalConfiguration.getConfigValue(ITEMS_EXPORT_BUTTON_NAME);
    }
    public  String getImportButtonName() {
        return globalConfiguration.getConfigValue(ITEMS_IMPORT_BUTTON_NAME);
    }
    public  String getSettingsButtonName() {
        return globalConfiguration.getConfigValue(ITEMS_SETTINGS_BUTTON_NAME);
    }
    public  String getSearchButtonName() {
        return globalConfiguration.getConfigValue(ITEMS_SEARCH_BUTTON_NAME);
    }
    public  String[] getItemsButtonCssClasses() {
        return globalConfiguration.getConfigValue(ITEMS_BUTTON_CSS_CLASSES).split(",");
    }
    public  String[] getItemsDropdownCssClasses() {
        return globalConfiguration.getConfigValue(ITEMS_DROP_DOWN_CLASS).split(",");
    }
    public  String getItemsAddItemCssClass() { return globalConfiguration.getConfigValue(ITEMS_ADD_ITEM_CSS_CLASS); }
    public  String getItemsLabelCategoryName(){
        return globalConfiguration.getConfigValue(ITEMS_LABEL_CATEGORY_NAME);
    }
    public  String getItemsTopHboxSpacing(){ return globalConfiguration.getConfigValue(ITEMS_TOP_HBOX_SPACING); }
    public  String getItemsLabelStockalertName(){ return globalConfiguration.getConfigValue(ITEMS_LABEL_STOCKALERT_NAME); }
    public  String getNextButtonName() {
        return globalConfiguration.getConfigValue(ITEMS_NEXT_BUTTON_NAME);
    }
    public  String getPrevButtonName() {
        return globalConfiguration.getConfigValue(ITEMS_PREV_BUTTON_NAME);
    }
    public  String getItemsBotHboxFooterRowsPerPageLabel() { return globalConfiguration.getConfigValue(ITEMS_BOT_HBOX_FOOTER_ROWS_PER_PAGE_LABEL); }
    public  String getItemsBotHboxFooterPageLabel() {
        return globalConfiguration.getConfigValue(ITEMS_BOT_HBOX_FOOTER_PAGE_LABEL);
    }
    public  String getItemsSettingsContextMenu() {return  globalConfiguration.getConfigValue(ITEMS_SETTINGS_CONTEXT_MENU);}
    public  String getItemsRowsPerPage() {return  globalConfiguration.getConfigValue(ITEMS_ROWS_PER_PAGE);}
    public  String getItemsStockAlerts() {return  globalConfiguration.getConfigValue(ITEMS_STOCK_ALERTS);}
